                                ...
                                <ul class="navbar-nav ml-auto">
                                    ...
                                    <li class="nav-item dropdown">
                                        ...
                                        <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                                            ...
                                            <a class="dropdown-item" href="<?php echo base_url('index.php/welcome/about')?>">About</a>
            ...
            <div class="row justify-content-center">
                <div class="col-10">
                    <div class="about-me-thumb">
                        <img src="<?php echo base_url()?>assets_frontend/img/bg-img/about-me.jpg" alt="">
                    </div>
                </div>
                <div class="col-10">
                    ...
                    <div class="row">
                        <div class="col-12 col-md-4">
                            <div class="single-service-area section_padding_0_100 text-center wow fadeInUp" data-wow-delay="0.1s">
                                <img src="<?php echo base_url()?>assets_frontend/img/core-img/heart.png" alt="">
                        ...
                        <div class="col-12 col-md-4">
                            <div class="single-service-area section_padding_0_100 text-center wow fadeInUp" data-wow-delay="0.4s">
                                <img src="<?php echo base_url()?>assets_frontend/img/core-img/photo-camera.png" alt="">
                        ...
                        <div class="col-12 col-md-4">
                            <div class="single-service-area section_padding_0_100 text-center wow fadeInUp" data-wow-delay="0.9s">
                                <img src="<?php echo base_url()?>assets_frontend/img/core-img/video-camera.png" alt="">
    ...
    <section class="follow-me-instagram-area clearfix">
        ...
        <div class="instagram-feeds-area owl-carousel">
            <div class="single-instagram-feeds">
                <img src="<?php echo base_url()?>assets_frontend/img/bg-img/i1.jpg" alt="">
                <a href="#"><i class="fa fa-instagram" aria-hidden="true"></i></a>
            </div>
            <div class="single-instagram-feeds">
                <img src="<?php echo base_url()?>assets_frontend/img/bg-img/i2.jpg" alt="">
                <a href="#"><i class="fa fa-instagram" aria-hidden="true"></i></a>
            </div>
            <div class="single-instagram-feeds">
                <img src="<?php echo base_url()?>assets_frontend/img/bg-img/i3.jpg" alt="">
                <a href="#"><i class="fa fa-instagram" aria-hidden="true"></i></a>
            </div>
            <div class="single-instagram-feeds">
                <img src="<?php echo base_url()?>assets_frontend/img/bg-img/i4.jpg" alt="">
                <a href="#"><i class="fa fa-instagram" aria-hidden="true"></i></a>
            </div>
            <div class="single-instagram-feeds">
                <img src="<?php echo base_url()?>assets_frontend/img/bg-img/i5.jpg" alt="">
                <a href="#"><i class="fa fa-instagram" aria-hidden="true"></i></a>
            </div>
            <div class="single-instagram-feeds">
                <img src="<?php echo base_url()?>assets_frontend/img/bg-img/i6.jpg" alt="">
                <a href="#"><i class="fa fa-instagram" aria-hidden="true"></i></a>
            </div>
            <div class="single-instagram-feeds">
                <img src="<?php echo base_url()?>assets_frontend/img/bg-img/i7.jpg" alt="">
                <a href="#"><i class="fa fa-instagram" aria-hidden="true"></i></a>
            </div>
        </div>
    </section>
